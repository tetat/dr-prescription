...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $permissions = [
            ...
            [
                'label' => 'Show Speciality',
                'name' => 'show-speciality',
                'group' => 'specialities'
            ],
            [
