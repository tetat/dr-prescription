...
import { edit, index, show } from '@/routes/institutes';
import { Institute } from '@/types';
import { Head, Link } from '@inertiajs/react';

const InstituteShow = ({ institute }: { institute: Institute }) => {
    const breadcrumbsData = [
        ...
        },
        {
            ...
            href: show(institute).url,
        },
    ];

    return (
        <AppLayout breadcrumbs={breadcrumbsData}>
            <Head title={`Institute: ${institute.name}`} />
