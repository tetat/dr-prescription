...
interface IndexProps {
    medForms: MedFormPagination;
    filters: FilterProps;
}

const MedFormIndex = ({ medForms, filters }: IndexProps) => {
    useFlashToast();
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbsData}>
            <Head title="Medicine Form Management" />
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl">
                <div className="relative min-h-[100vh] flex-1 rounded-xl border border-sidebar-border/70 p-4 md:min-h-min dark:border-sidebar-border">
                    ...
                    <Table>
                        <TableCaption>A list of Medicine Forms.</TableCaption>
                        <TableHeader>
                            <TableRow>
                        ...
                        <TableBody>
                            {medForms.data.length > 0 ? (
                                medForms.data?.map((medForm, index) => (
                                    <TableRow key={medForm.id}>
